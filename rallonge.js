...
var recordButton = document.getElementsByClassName("startRecord")
var stopButton = document.getElementsByClassName("pauseRecord");
var pauseButton = document.getElementsByClassName("stoprecord");
...
//   li.appendChild(au);
  // li.appendChild(link);
  // document.querySelector('div').appendChild(au);
